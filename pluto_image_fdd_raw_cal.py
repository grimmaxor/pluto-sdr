...
--------------------------------------
Phase 1 beacons at a fixed CAL_TX_ATTEN (-30 dB).  If the link cannot
bridge at that power, the gain sweep finds nothing, retries 8 times, then
falls back to the default rx_gain.  Phase 2 then sweeps TX power with
...
Usage (same as pluto_image_fdd_raw.py):
  ...
  Pluto 2 (receiver): python pluto_image_fdd_raw_cal.py --role rx --out-dir ./received
  Skip cal:           add --skip-cal --rx-gain N --tx-atten N
"""
...
ap.add_argument('--rx-gain',   type=int,   default=40,
                help='RX gain (dB) — fallback / --skip-cal value')
ap.add_argument('--tx-atten',  type=int,   default=-20,
                help='TX attenuation (dB) — fallback / --skip-cal value')
...
# ═══════════════════════════════════════════════════════════════════════════════
#  DSP  (BPSK)  — unchanged from pluto_image_fdd_raw.py
# ═══════════════════════════════════════════════════════════════════════════════
def make_filter(sps):
...
# ═══════════════════════════════════════════════════════════════════════════════
#  PLUTO  — unchanged from pluto_image_fdd_raw.py
# ═══════════════════════════════════════════════════════════════════════════════
def setup_pluto():
...
# ═══════════════════════════════════════════════════════════════════════════════
#  SENDER  — unchanged from pluto_image_fdd_raw.py
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
#  RECEIVER  — unchanged from pluto_image_fdd_raw.py
# ═══════════════════════════════════════════════════════════════════════════════
